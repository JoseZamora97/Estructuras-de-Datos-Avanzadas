package practicas.practica3.bynarytree;
...
import practicas.practica3.iterators.LevelBinaryTreeIterator;

@SuppressWarnings("unchecked")


/**
 * Practica 3 EJercicio 2. Resolucion.
 *
...
public class ArrayBinaryTree<E> implements BinaryTree<E> {
    ...
    private class BTPos<T> implements Position<T> {
        ...
        BTPos(T element, int index, ArrayBinaryTree<T> tree) {
